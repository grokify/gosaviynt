...
// checks if the FetchRuntimeControlsDataV2Request type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchRuntimeControlsDataV2Request{}

// FetchRuntimeControlsDataV2Request struct for FetchRuntimeControlsDataV2Request
type FetchRuntimeControlsDataV2Request struct {
...
func NewFetchRuntimeControlsDataV2Request() *FetchRuntimeControlsDataV2Request {
	this := FetchRuntimeControlsDataV2Request{}
	return &this
}
...
func (o FetchRuntimeControlsDataV2Request) MarshalJSON() ([]byte, error) {
...
func (o FetchRuntimeControlsDataV2Request) ToMap() (map[string]interface{}, error) {
...
type NullableFetchRuntimeControlsDataV2Request struct {
	value *FetchRuntimeControlsDataV2Request
	isSet bool
}

func (v NullableFetchRuntimeControlsDataV2Request) Get() *FetchRuntimeControlsDataV2Request {
	return v.value
}

func (v *NullableFetchRuntimeControlsDataV2Request) Set(val *FetchRuntimeControlsDataV2Request) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchRuntimeControlsDataV2Request) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchRuntimeControlsDataV2Request) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchRuntimeControlsDataV2Request(val *FetchRuntimeControlsDataV2Request) *NullableFetchRuntimeControlsDataV2Request {
	return &NullableFetchRuntimeControlsDataV2Request{value: val, isSet: true}
}

func (v NullableFetchRuntimeControlsDataV2Request) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchRuntimeControlsDataV2Request) UnmarshalJSON(src []byte) error {
	v.isSet = true
